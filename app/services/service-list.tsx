...
function ServiceCard({icon, headerText, description}: {icon: React.ReactElement; headerText: string; description: string}) {
    return (
        <FadeSlideWrapper className="relative p-8 bg-white transition-all text-center rounded-lg shadow-lg max-w-sm hover:scale-105 group">
            <span
                className="w-fit p-3.5 inline-grid place-content-center h-16 mb-6 text-5xl font-semibold span-animation mx-auto border-2 border-dotted border-primary/80 text-primary group-hover:bg-primary/80 group-hover:text-white group-hover:border-none">
                {icon}
            </span>
            <div className="space-y-4">
                <h3 className="text-xl md:text-2xl font-semibold text-primary">{headerText}</h3>

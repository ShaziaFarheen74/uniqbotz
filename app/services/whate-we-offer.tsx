        ...
        <div className="py-20 space-y-20">
            ...
            <div className="text-center space-y-10">
                ...
                <div className="text-center space-y-4 max-w-3xl mx-auto container">
                    <FadeSlideWrapper>
                        <h2 className="text-4xl md:text-5xl font-semibold text-primary">Industries We Serve</h2>
                    </FadeSlideWrapper>
                    <FadeSlideWrapper>
                        <p className="text-lg md:text-xl text-foreground/90">
                            UniqBotz Infotech partners with diverse industries to harness the power of RPA, streamlining complex workflows, increasing
                            operational efficiency, and driving value. Our tailored automation solutions transform key processes across sectors,
                            helping each industry meet its unique challenges and thrive in a competitive landscape.
                        </p>
                    </FadeSlideWrapper>
                </div>
            </div>
        ...
        <FadeSlideWrapper>
            ...
            <div className={cn("flex items-center justify-between p-10 shadow-all relative overflow-hidden group" +
                ...
                <div className="flex items-center gap-x-4">
                    {icon}
                    <div className="duration-500 space-y-2">
                        {
                            openIndustry === itemNum ? <p className="text-lg md:text-xl">{description}</p> : 
